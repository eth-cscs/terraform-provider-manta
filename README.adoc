...
* [x] CRUD redfish endpoint
* [x] CRUD boot script
* [x] Switch power status of a node
* [x] Passing cloud-init data
* [x] Attribute IP address to a node mac address
* [x] Boot an O/S diskless
...
=== Edit terraform's configuration to override the source for the Manta provider
...
* [x] fix errors of `golangci-lint run`
* [ ] reproduce `examples` folder as standard (eg., https://github.com/hashicorp/terraform-provider-scaffolding-framework/tree/main/examples[terraform-provider-scaffolding-framework])
* [ ] adapt tools folder
...
* https://www.hashicorp.com/en/resources/creating-terraform-provider-for-anything[Creating a Terraform Provider for Just About Anything] (text)
* https://youtu.be/noxwUVet5RE[Creating a Terraform Provider for Just About Anything] (video)
* https://developer.hashicorp.com/terraform/plugin/framework-benefits[SDKv2 or Terraform Plugin Framework] (Why choose the Terraform Plugin Framework over SDKv2?)

=== Examples of Terraform provider

* https://github.com/cyrusjavan/terraform-provider-example[terraform-provider-example] (simple)
* https://gitlab.com/gitlab-org/terraform-provider-gitlab[terraform-provider-gitlab] (complex)

=== HashiCorp

* https://developer.hashicorp.com/terraform/plugin/framework[Terraform plugin framework] (documentation)
* https://developer.hashicorp.com/terraform/tutorials/providers-plugin-framework[Terraform provider tutorial]
